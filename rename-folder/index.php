							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?> role="article">
								...
								<header class="article-header">
									...
									<p class="byline vcard"><?php
										printf( __( 'Posted <time class="updated" datetime="%1$s" pubdate>%2$s</time> by <span class="author">%3$s</span> <span class="amp">&</span> filed under %4$s.', 'webdraftertheme' ), get_the_time('Y-m-j'), get_the_time(get_option('date_format')), webdraftertheme_get_the_author_posts_link(), get_the_category_list(', '));
									?></p>
